...
import {fetchOnboardBusinessById, fetchOnboardById} from "@/app/lib/data";
import FormContainer from "@/app/ui/business/onboard/form-container";


export default async function CreatorPage({ params }: { params: { id: string } }) {

    const userData = await fetchOnboardBusinessById(params.id);

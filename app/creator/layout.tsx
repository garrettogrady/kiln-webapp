...
import {ArrowTopRightOnSquareIcon, HomeIcon, ReceiptPercentIcon, UserGroupIcon} from "@heroicons/react/24/outline";
...
export default async function Layout({children}: { children: React.ReactNode }) {
    ...
    if ( user?.user?.type === 'admin'){
        console.log('admin logged in, showing admin links')
        links = [

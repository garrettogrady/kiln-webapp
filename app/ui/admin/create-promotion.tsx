...
import {createAdminPromotion, createPromotion} from '@/app/lib/actions'; // Assume this function exists
import Tooltip from "@/app/ui/campaigns/tooltip";

export default function PromotionForm(businessId: string) {
    const initialState = { message: null, errors: {} };
    const [state, dispatch] = useFormState(createAdminPromotion, initialState);

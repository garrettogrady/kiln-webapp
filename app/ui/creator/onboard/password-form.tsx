...
import {creatorOnboard} from "@/app/lib/actions";
import {fetchOnboardById} from "@/app/lib/data";
import {CreatorOnboardData} from "@/app/lib/definitions";

const PasswordForm: React.FC<{ creatorData: CreatorOnboardData }> = ({ creatorData }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push('/creator-onboard/'+creatorData.id+'/provision')
        } catch (error) {

...
import {fetchLatestInvoices, fetchLatestTransactionsFromUser, fetchPastPromotionsFromUser, fetchLatestPromotionsFromUser} from "@/app/lib/data";
...
export default async function LatestPromotions({id}: { id: string }) {
    ...
    const currentPromotions = await fetchLatestPromotionsFromUser(id);
